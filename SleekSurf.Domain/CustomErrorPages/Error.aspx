<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="SleekSurf.Domain.CustomErrorPages.Error" %>
    ...
    <div id="Wrapper" class="adminWrapperSettings">
        ...
        <div class="showErrorMessage">
            ...
            <p>
                ...
                <asp:HyperLink runat="server" ID="lnkContact" Text="Contact Us" NavigateUrl="~/ContactUs.aspx" />.
                <br />
                <br />
                Sorry for any inconvenience. You will be redirected to default page in few seconds.
            </p>
            <div>
                <asp:ImageButton ID="ImageButtonOops" runat="server" ImageUrl="~/App_Themes/Default/Images/Oops.png"
