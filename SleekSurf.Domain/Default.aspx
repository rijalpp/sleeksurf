<%@ Page Title="" Language="C#" MasterPageFile="~/ClientSite.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SleekSurf.Domain.Default" %>
            ...
            <div class="featuredInside">
                ...
                <ul id="PromoSlider">
                    <li id="PromotionSlide1" runat="server" visible="false">
                        <img src="/Images/Promotion1Default.png" alt="Promotion 1" />
                    </li>
                    <li id="PromotionSlide2" runat="server" visible="false">
                        <img src="/Images/Promotional2Default.png" alt="Promotion 2" />
                    </li>
                            ...
                            <li class="promotionSlide">
                                ...
                                <div class="promotionInfo">
                                    ...
                                    <p class="promotiondate">
                                        Start Date :
                                        <%# Eval("StartDate","{0:dd/MM/yyyy}")%></p>
                                    <p class="promotiondate">
                                        End Date :
                                        <%# Eval("EndDate","{0:dd/MM/yyyy}")%></p>
                                ...
                                <div class="promotionDescription">
                                    ...
                                    <p class="descriptiontext">
                                        <%# this.GetShortDescription(Eval("Description").ToString(), 60)%>
                                    </p>
                                </div>
                            </li>
                        </ItemTemplate>
        ...
        <div id="ClientContentPromotionLocation">
            <div id="ClientContentPromotion">
                <div class="promoHeader">
                    <h2>
                        <asp:Label ID="lblPromotionHeader" runat="server"></asp:Label></h2>
                </div>
