...
namespace SleekSurf.Web.WebPageControls
{
    public partial class NewEditCustomer : System.Web.UI.UserControl
    {
        ...
        public void ExtractCustomerGroups(string customerGroupID)
        {
            ...
            Result<CustomerGroupDetails> result = CustomerManager.SelectAllCustomerGroup(WebContext.Parent.ClientID);
            if (result.Status == ResultStatus.Success)
            {
        ...
        public void SetProfileImageVisibility(bool setVisibility)
        {
            divFileUpload.Visible = setVisibility;
        }
