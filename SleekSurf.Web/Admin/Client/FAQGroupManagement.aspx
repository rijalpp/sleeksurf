<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true"
    CodeBehind="FAQGroupManagement.aspx.cs" Inherits="SleekSurf.Web.Admin.Client.FAQGroupManagement" %>
                        ...
                        <div>
                            <asp:Panel ID="pnlFaqs" runat="server">
                                ...
                                <asp:GridView ID="gvFaqManagement" runat="server" DataKeyNames="FaqID, FaqGroup"
                                    ...
                                    <EmptyDataTemplate>
                                        No Faq found for the Client. Please add the Frequentrly asked questions and answers
                                        below.
                                    </EmptyDataTemplate>
                                    <EmptyDataRowStyle CssClass="normalMsg" />
                                    <Columns>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="div" style="display: table">
                                            ...
                                            <div class="cell" style="padding-right: 5px;">
                                                <cc1:Editor ID="editorAnswer" runat="server" Width="640px" Height="200px" />
                                            </div>
                                            <div class="cell">
