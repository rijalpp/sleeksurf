...
namespace SleekSurf.Web.Admin.Client
{
    public partial class FAQGroupManagement : System.Web.UI.Page
    {
        ...
        protected void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            {
                gvFaqGroupManagement.Columns[0].Visible = false;
                gvFaqManagement.Columns[0].Visible = false;
            }
        ...
        protected void gvFaqGroupManagement_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("AddNew"))
            {
                ...
                faqGroup.FaqGroupID = DateTime.Now.ToString("FG-ddMMyy-HHmmssfff");
                faqGroup.Client = WebContext.Parent;
        ...
        protected void gvFaqGroupManagement_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow) //e.Row.RowState == DataControlRowState.Edit
            {
                ...
                {
                    Result<FAQGroupDetails> result = ClientManager.SelectFaqGroupByClientID(WebContext.Parent.ClientID);
        ...
        private void SearchFaqGroup()
        {
            ...
            if (result.Status == ResultStatus.Success)
            {
                ...
                {
                    gvFaqGroupManagement.DataSource = ClientManager.SelectFaqGroupByClientID(WebContext.Parent.ClientID).EntityList;
        ...
        private void UpdateFaqGroup(string faqGroupID, int index)
        {
            ...
            faqGroup.Client = new ClientDetails() { ClientID = WebContext.Parent.ClientID };
        ...
        protected void imgDeleteBtnFaq_Click(object sender, EventArgs e)
        {
            ...
            using (TransactionScope scope = new TransactionScope())
            {
                try
                {
                    ...
                    lblMessageFaq.Text = faqIDList.Count + " Record(s) successfully deleted.";
        ...
        private void SaveFaq()
        {
            ...
            {
                faq.FaqID = DateTime.Now.ToString("FQ-ddMMyy-HHmmssfff");
