...
{
    public partial class MatchDomain : System.Web.UI.Page
    {
        ...
        {
            PackageDetails package = ClientPackageManager.SelectPackageByFeatureType(FeatureType.ClientDomain.ToString()).EntityList[0];
            if (package != null)
            {
        ...
        private void SavePackageType()
        {
            if (HttpContext.Current.User.Identity.IsAuthenticated)
            {
                ...
                if (!string.IsNullOrEmpty(clientID))
                {
                    ...
                    PackageDetails tempPackage = ClientPackageManager.SelectPackageByFeatureType(FeatureType.ClientProfile.ToString()).EntityList[0];
