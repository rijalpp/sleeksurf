<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true"
    CodeBehind="AdvertisementManagement.aspx.cs" Inherits="SleekSurf.Web.Admin.Client.AdvertisementManagement" %>
    ...
    <div id="WrapperMasterPage">
        <div id="LeftContentMasterPage">
            ...
            <div>
                ...
                <div>
                    <asp:GridView ID="gvAdvertisementManagement" runat="server" DataKeyNames="AdID, ImageUrl, Email"
                        AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="gvAdvertisementManagement_RowDataBound"
                        OnSelectedIndexChanging="gvAdvertisementManagement_SelectedIndexChanging" OnRowUpdating="gvAdvertisementManagement_RowUpdating"
                        OnRowCancelingEdit="gvAdvertisementManagement_CancellingEdit" OnRowEditing="gvAdvertisementManagement_RowEditing">
                        <EmptyDataTemplate>
        ...
        <div id="RightContentMasterPage">
            <div class="rightLinks">
                <asp:HyperLink ID="hlAddNewAd" runat="server" Text="Add New Ad" NavigateUrl="~/Admin/Client/NewEditAdvertisement.aspx"
