...
namespace SleekSurf.Web.WebPages
{
    public partial class ViewProfile : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            selectedUser = Membership.GetUser(HttpContext.Current.User.Identity.Name);
        ...
        private void ChangeSecretQuestionAnswer()
        {
            ...
            if (selectedUser.ChangePasswordQuestionAndAnswer(userPassword, secretQuestion, secretAnswer))
            {
                ...
                string body = "Hello: " + selectedUser.UserName + "(" + userInfo.FirstName + " " + userInfo.MiddleName + " " + userInfo.LastName + ") </ br>The followings are you new Secret question and answers:</ br>";
                body += "Secret Question: " + secretQuestion + "</ br>";
                body += "Secret Answer: " + secretAnswer;
                body += "Please change your Secret Questions and answers as soon as you retrieve your password.";
                ...
                lblMessage.Text = "New Secret questions and answers have been sent to user.";
