<%@ Page Title="" Language="C#" MasterPageFile="~/SleekSurf.Master" AutoEventWireup="true"
    CodeBehind="TermsAndConditions.aspx.cs" Inherits="SleekSurf.Web.WebPages.TermsAndConditions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrapContent">
        <div id="TermsAndConditions">
            ...
            <%=SleekSurf.Manager.ClientManager.SelectDataExtenderWithClientNull().EntityList[0].TermsAndConditions%>
        </div>
