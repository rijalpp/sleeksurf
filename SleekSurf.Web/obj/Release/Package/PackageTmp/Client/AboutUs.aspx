<%@ Page Title="" Language="C#" MasterPageFile="~/Client/ClientPageSite.master" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="SleekSurf.Web.Client.AboutUs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderPage" runat="server">
    <div id="AboutUs">
        <h2 class="header" style="color:#777777;">About Us</h2>
        <p>
