<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true"
    CodeBehind="UserManagement.aspx.cs" Inherits="SleekSurf.Web.Admin.Client.UserManagement" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ MasterType VirtualPath="~/Admin/AdminSite.Master" %>
    ...
    <div id="WrapperMasterPage">
            ...
            <div id="TitleSearch">
                ...
                <div class="search">
                    ...
                    <span class="marginSideBySide">
                        ...
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtUsername"
                            ValueToCompare="Search Username" Type="String" Operator="NotEqual" ValidationGroup="valgUserNameSearch" />
                    </span>
                    <asp:Button ID="btnSearch" runat="server" SkinID="SearchButtonSmall" Text="Search"
                        OnClick="btnSearch_Click" ValidationGroup="valgUserNameSearch" />
                </div>
            </div>
            <div>
                ...
                <asp:GridView ID="gvUserManagement" runat="server" DataKeyNames="ProviderUserKey, UserName"
                    ...
                    OnPageIndexChanging="gvUserManagement_PageIndexChanging" OnRowCancelingEdit="gvUserManagement_RowCancellingEdit"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Email">
                            ...
                            <EditItemTemplate>
                                <asp:UpdatePanel runat="server" ID="upnlEmail">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtEmail" runat="server" Width="150px" Text='<%# Bind("Email") %>'
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:Image ID="imgDelete" runat="server" ImageUrl="~/App_Themes/SleekTheme/Images/UserLockOut.png"
        ...
        <div id="RightContentMasterPage">
            <div class="rightLinks">
                <asp:HyperLink ID="hlAddNewUser" runat="server" Text="Add New User" NavigateUrl="~/Admin/Client/NewEditUser.aspx"
