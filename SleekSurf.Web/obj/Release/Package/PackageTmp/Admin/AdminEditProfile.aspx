<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true"
    CodeBehind="AdminEditProfile.aspx.cs" Inherits="SleekSurf.Web.Admin.AdminEditProfile" %>
                                    ...
                                    <ContentTemplate>
                                        <div>
                                            ...
                                            <asp:RegularExpressionValidator ID="rexEmail" runat="server" Display="Dynamic" ControlToValidate="txtEditEmail"
                                                 ErrorMessage="Invalid Email Fromat" ValidationGroup="valAccountEdit"
                    ...
                    <asp:UpdatePanel runat="server" ID="upAttachSupportingImage">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="pBody" runat="server" CssClass="adminOnly">
                                ...
                                <div style="padding: 10px 20px 5px; width: 655px; border-bottom: 1px solid #CCC;
