<%@ Page Title="" Language="C#" MasterPageFile="~/Client/ClientPageSite.master" AutoEventWireup="true"
    CodeBehind="PromotionInDetails.aspx.cs" Inherits="SleekSurf.Web.Client.PromotionInDetails" %>
        ...
        <div class="promo">
            ...
            <div id="PromotionImageGallery" runat="server" class="gallery">
                <div class="titleBar">
                    ...
                    <div class="titleBarMiddle">Image Gallery</div>
            ...
            <div id="PromotionVideoGallery" runat="server" class="gallery">
                <div class="titleBar">
                    <div class="titleBarLeft"></div>
                    <div class="titleBarMiddle">Video Gallery</div>
                    <div class="titleBarRight"></div>
                </div>
                <div class="divider"></div>
                <div id="VideoGallery">
